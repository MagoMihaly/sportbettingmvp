      ...
      <CardContent>
        <form action={updateSoccerSettingsAction} className="space-y-6">
          ...
          <p className="text-sm leading-6 text-slate-400">
            The soccer module is isolated from the existing hockey engine. When API-Football credentials are added, the scheduler-ready ingest layer can start filling watchlists, state snapshots, odds snapshots and live alerts without changing the hockey flow.
          </p>
