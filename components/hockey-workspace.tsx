...
export function HockeyWorkspace({ payload }: { payload: DashboardPayload }) {
  const { alerts, profile, pushSubscriptions, signals, settings, stats, provider, viewer } = payload;
      ...
      <div className="grid gap-6 xl:grid-cols-[1.15fr_0.85fr]">
        <Card>
          <CardHeader>
            ...
            <CardTitle>Active hockey leagues</CardTitle>
          </CardHeader>
